    ...
    return (
        <div className="container">
            <div className="" style={{ width: "100%" }}>
                ...
                <div className="" style={style.kanbanContainer}>
                    {Object.keys(boardData).map((phase, stage) => (
                        <div
                            key={Number(Math.random()).toString(16)}
                            className="kanban-phases"
                            onDragEnter={() => (dragZone.columnDest = stage)}
                        >
                            <div className="" style={style.kanbanColumn}>
                                <div
                                    className=""
                                    style={style.kanbanHeader(color[stage])}
                                >
                                    {phase}
                                </div>
                                <div className="">
